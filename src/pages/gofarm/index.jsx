    ...
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h1 className="mt-20 p-bold" ref={bg2Ref}>
                Go Farm{" "}
                <span className="t-hijau fs-30">
              ...
              <a href="#">
                <div class="card-body">
                  <div className="row">
                    ...
                    <div className="col-8">
                      <h2 className="t_putih p-bold text-center">
                        Data Penyuluh
                      </h2>
                    </div>
                  </div>
      ...
      <div className="container">
        <div className="row mt-50 mb-100">
          ...
          <div className="col-6">
            <h2 className="p-semibold fs-30">Manfaat hidroponik</h2>
            <hr />

            <ul className="p-medium fs-20 listmisi mt-100">
              <li>Tanaman untuk tumbuh dan produksi lebih terjamin.</li>
              <li>Perawatan lebih praktis dan gangguan hama lebih terkontrol.</li>
